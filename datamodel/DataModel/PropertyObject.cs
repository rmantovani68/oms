...
namespace DataModel
{
    ...
    public class PropertyObject : BaseObject
    {
        ...
        private PropertyObjectType _propertytype;
        [System.Xml.Serialization.XmlAttribute]
        public PropertyObjectType propertytype { get { return _propertytype; } set { _propertytype = value; } }
        ...
        public PropertyObject(XmlNode node)
            : this(null, node)
        {
        ...
        private object ParsePropertyValue(PropertyObjectType type, string Value)
        {
            try
            {
                switch (type)
                {
                    case PropertyObjectType.Bool: return bool.Parse(Value);
                    case PropertyObjectType.Byte: return Byte.Parse(Value);
                    case PropertyObjectType.Dint: return int.Parse(Value);
                    case PropertyObjectType.Int: return int.Parse(Value);
                    case PropertyObjectType.Long: return int.Parse(Value);
                    case PropertyObjectType.Real: return int.Parse(Value);
                    case PropertyObjectType.Word: return short.Parse(Value);
                }
